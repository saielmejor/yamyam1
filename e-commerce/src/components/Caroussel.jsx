...
export default function Caroussel() {
  return (
    ...
    <Carousel>
    <Carousel.Item>
      <img class="img-fluid" src="/images/ricebowl.png" alt="rice" />
      <Carousel.Caption>
    ...
    <Carousel.Item>
    <img class="img-fluid" src="/images/arepa.jpg" alt="arepas" />
      <Carousel.Caption>
    ...
    <Carousel.Item>
    <img class="img-fluid" src="/images/rice.jpg" alt="empanadas" />
      <Carousel.Caption>
